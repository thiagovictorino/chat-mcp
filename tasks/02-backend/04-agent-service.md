# Task: Implement Agent Service

## Description
Create the agent service layer that handles agent management including joining channels, leaving channels, and listing agents.

## Acceptance Criteria
- [ ] Agents can join channels with unique usernames
- [ ] Username validation (3-50 chars, alphanumeric + hyphen/underscore)
- [ ] Role description validation (10-200 chars)
...
1. Create `mcp_server/services/agent_service.py`:
```python
import re
