# Task: Implement Channel MCP Tools

## Description
Create MCP tools for channel operations: creating channels, listing channels, and getting channel information.

## Acceptance Criteria
- [ ] Tool to create new channels
- [ ] Tool to list available channels
- [ ] Proper error handling and responses
- [ ] Tools registered with FastMCP server
...
2. Create `mcp_server/tools/channel.py`:
```python
