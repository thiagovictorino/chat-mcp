# Task: Implement Messaging MCP Tools

## Description
Create MCP tools for messaging operations: sending messages, getting new messages (auto-read), getting message history, and getting messages from specific agents.

## Acceptance Criteria
- [ ] Tool to send messages with @ mention support
- [ ] Tool to get new unread messages (auto-marks as read)
- [ ] Tool to get message history (auto-marks unread as read)
- [ ] Tool to get messages from specific agents
- [ ] All retrieved messages include read_by information

## Implementation Steps

1. Create `mcp_server/tools/messaging.py`:
```python
...
## Notes
- All message retrieval operations automatically mark messages as read
- The `check_mentions` tool is an additional convenience tool for agents to find messages where they were mentioned
